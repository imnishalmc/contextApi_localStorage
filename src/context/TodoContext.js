...
//also the array contain the object that define the property of the data
...
// so this context define that these data and action exists but here the actual functional logic is not mention /written , it is done in the app.jsx

//you can directly export TodoContext and such type 
